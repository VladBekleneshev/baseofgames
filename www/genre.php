...
<div class="section">
			<?php
				$genre = $_GET['game_genre'];
      			include('db.php');
				$sql = "SELECT `id`, `image` FROM pc_games WHERE game_genre = '$genre'";
				...
				else
				{
					...
					echo "<a class='caption' href='genre.php?game_genre=".$genre."'>";
					if($genre == 'action')
					{
						$genre = 'Экшен';
					}
